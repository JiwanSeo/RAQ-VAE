...
def main():
    ...
    model = PixelSNAIL_KMVQ(n_codes=args.cluster_target, n_filters=128, n_res_blocks=10, n_snail_blocks=3, n_condition_blocks=5, vq_model=vq_model, args=args).to(device)
    ...
    best_model = PixelSNAIL_KMVQ.load_from_checkpoint(checkpoint_callback.best_model_path, n_codes=args.cluster_target, n_filters=128, n_res_blocks=10, n_snail_blocks=3, n_condition_blocks=5, vq_model=vq_model, args=args)
