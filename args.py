...
def parse_args():
    ...
    # KMVQ options
    parser.add_argument('--cluster_target', type=int, default=2048, help='Codebook clustering taget')
    ...
    parser.add_argument("--num_embeddings_max", type=int, default=1024,
                        help="maximum vocabulary size; number of possible discrete states")
    parser.add_argument("--num_embeddings_test", type=int, default=1024,
