...
def main():
    ...
    model = VRVQ(args=args)

    logger = TensorBoardLogger(save_dir=args.save_dir + "vrvq/" + str(args.dataset)
    ...
    best_model = VRVQ.load_from_checkpoint(checkpoint_callback.best_model_path, args=args)
